import { C as useOpsBase, S as OpsLink, b as AppShell, i as layersQuery, m as getDataPlaneStatus, x as PageHeader } from "./use-ops-data-QkGo7WN-.js";
...
function DeploymentPage() {
	...
	const services = [
		...
		},
		{
			...
			detail: auroraEndpointWired ? "Azure ML endpoint provisioned; WeatherEvent response adapter still required" : "Select Aurora and provide its model asset ID in the Azure deployment form",
			wired: auroraEndpointWired && auroraAdapterConnected,
			statusLabel: auroraEndpointWired ? "Adapter required" : "Not configured"
		}
	];
