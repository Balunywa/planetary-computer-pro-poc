import { i as getServerFnById, n as createServerFn, r as TSS_SERVER_FUNCTION } from "./server-CerJU9nu.js";
...
var AzurePostureService = class {
	...
	async setGate(_assetId, _gate, _state) {
		return [];
	}
	async setProductionStatus(_assetId, _status) {
		return [];
	}
...
var MockAlertService = class {
	...
	async setStatus(id, status) {
		this.alerts = this.alerts.map((a) => a.id === id ? {
			...a,
			status
		} : a);
		return this.alerts;
...
//#endregion
export { useOpsBase as C, OpsLink as S, METRIC_LABEL as _, postureQuery as a, AppShell as b, getServices as c, POSTURE_GATES as d, POSTURE_LEVEL_LABEL as f, uploadAsset as g, seedPublicSample as h, layersQuery as i, nearbyAssets as l, getDataPlaneStatus as m, assetsQuery as n, thresholdRulesQuery as o, gateStateLabel as p, eventsQuery as r, useOpsSnapshot as s, alertsQuery as t, scoreAsset as u, METRIC_UNIT as v, cn as w, PageHeader as x, evaluateRules as y };
